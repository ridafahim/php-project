...
<div class="container-fluid" height="1000"  style="background-image: url('img/banner/downlod2.jpg');">
<div class="container">
...
<!--  
 ...
 -->
	<div class="row pl-0">
		...
		<div class="col-md-8">
			<h2 style="color:white"> Uploading new song</h2>

			<form method="post" action="admin_song_upload.php" enctype="multipart/form-data">
			  <div class="form-group">
			    <label for="song_name" style="color:white">Song name</label>
			    <input type="text" name="song_name" class="form-control" id="song_name"  placeholder="Enter song name"> 
			  </div>


			  <div class="form-group">
			    <label for="aritst_id" style="color:white" style="color:white">Artist name</label>
 			  ...
 			  <div class="form-group">
			    <label for="song_photo" style="color:white">Song photo</label>
			    <input type="file"  name="song_photo" class="form-control" id="song_photo"> 
			  </div>


 			  <div class="form-group">
			    <label for="song_mp3" style="color:white">Song mp3</label>
